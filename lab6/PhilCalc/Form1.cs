...
namespace PhilCalc
{
    public partial class PhilCalculator : Form
    {
        ...
        string operation = "";
        public PhilCalculator()
        {
            InitializeComponent();
        }

        private void PhilCalculator_Load(object sender, EventArgs e)
        {
        ...
        private void PhilCalculator_KeyPress(object sender, KeyPressEventArgs e)
        {
